...
export default connect(null, {upVoteComment, downVoteComment})(CommentCard)


// create a column for comments for upvotes and/or downvotes
// persist to api backend so that refreshed persist
// remove local state from CommentCard
